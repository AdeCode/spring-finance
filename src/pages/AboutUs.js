  ...
  return (
    <Wrapper>
        ...
        <div className="bg-aboutMB lg:bg-aboutBG flex flex-col items-center lg:flex-row h-fit lg:px-[200px] justify-between pt-[29px] pb-[13px] lg:pt-[60px] lg:pb-[90px]">
            ...
            <p className='w-[339px] font-normal text-xs lg:text-start text-center lg:w-[500px] lg:font-bold lg:text-lg'>Spring is a pan-African financial services provider that offers fast, easy, convenient, and secure local & cross-border payment solutions. Our mission is to provide a better way for individuals, international students, SMEs from Africa to send and recieve money seamlessly from anywhere.</p>
        </div>
        <div className='flex justify-center'>
            <img src={springMB} alt="spring" className='lg:hidden'/>
            <img src={springBG} alt="spring" className='hidden lg:flex'/>
        </div>
        <div className='flex lg:px-[200px] flex-col mt-[30px] lg:mt-[80px]'>
            <h1 className='w-full px-3 lg:w-[645px] lg:font-normal text-2xl lg:text-6xl leading-[29px] lg:text-left text-center font-medium lg:leading-[69px]'>Our Core Values are wrapped into the word BORDERLESS</h1>
        ...
        <div className='bg-purpleMB lg:bg-purpleBG bg-no-repeat h-full bg-blue-bg mt-[28px] lg:mt-[124px] w-full bg-cover'>
