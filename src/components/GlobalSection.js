    ...
    <Section>
        ...
        <div className='bottom hidden lg:h-auto w-full bg-blue-bg justify-between lg:flex px-[200px] lg:pt-[100px]'>
                ...
                <div className='lg:w-[600px] flex flex-col items-center'>
                    <h2 className='text-white tracking-tight font-semibold text-center lg:text-[39px]'>Start sending money to friends, family and also businesses with Spring today with no fuss.</h2>
                    <div className='text-blue-bg text-lg bg-white py-4 px-9 w-fit mt-[26px] rounded-lg font-semibold cursor-pointer'>Join our waitlist</div>
                </div>
                <div>
